...
def add_optimization_args(parser):
    ...
    # fmt: off
    group.add_argument('--recover-epoch', '--re', default=0, type=int, metavar='N',
                       help='number of recover epochs after enlargin')
    group.add_argument('--max-epoch', '--me', default=0, type=int, metavar='N',
                       help='force stop training at specified epoch')
    group.add_argument('--recover-update', '--ru', default=0, type=int, metavar='N',
                       help='number of recover updates after enlarging')
    group.add_argument('--max-update', '--mu', default=None, type=str,
    ...
    parser.add_argument('--domains', type=str, help='order of domains')
    group.add_argument('--replay', default=False, action='store_true',
                       help='whether use replay')
    group.add_argument('--replay_interval', default=100, type=int,
                       help='number of updating between two times of replaying.')
    group.add_argument('--replay_steps', default=10, type=int,
                       help='number of updating when replaying.')
    group.add_argument('--sample_numbers', default=1000, type=int,
                       help='total number of samples in the memory bank')
    group.add_argument('--added_head_num', default='2:2:1:1', type=str)
    group.add_argument('--added_layer_num', default='2:2:1:1', type=str)
    group.add_argument('--is_always_left', default=False, action='store_true',
                       help='pattern of expanding hidden dim')
    group.add_argument('--add-noise', default=False, action='store_true',
                       help='add noise when enlarging model')
    ...
    group.add_argument('--arch_distil_from', default='roberta_9_576', type=str)
    group.add_argument('--models_distil_from', default=None, type=str)
    group.add_argument('--replay_distil_ratio', default=1, type=float)
    group.add_argument('--replay_ratio', default=0.1, type=float)
    group.add_argument('--use_domain_prompt', default=False, action='store_true')
    group.add_argument('--use_domain_embeddings', default=False, action='store_true')
    group.add_argument('--use_teacher_model', default=False, action='store_true')
    group.add_argument('--validation_interval_updates', default=1000, type=int)
    group.add_argument('--validation_interval_time', default=1800, type=int)
    group.add_argument('--ppl_decreased_min', default=1e-9, type=float)
    group.add_argument('--ppl_decreased_max', default=1, type=float)
    group.add_argument('--add_last', default=False, action='store_true')
    group.add_argument('--FPI_new', default=False, action='store_true')
    group.add_argument('--memory_dir', default=None, type=str)
    group.add_argument('--first_equal_replay', default=False, action='store_true')
    group.add_argument('--max_train_times', default=None, type=str)
    group.add_argument('--memory_ratio', default=1, type=float)
    # fmt: on
    return group
