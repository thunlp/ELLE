...
class PolynomialDecaySchedule(FairseqLRScheduler):
    ...
    def __init__(self, args, optimizer):
        ...
        self.total_num_update = args.cur_max_update
        self.warmup_updates = int(self.total_num_update * args.warmup_ratio)
    ...
    def add_args(parser):
        ...
        parser.add_argument('--total-num-update', default=None, type=str)
