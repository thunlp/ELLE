...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--checkpoint_name", default=None, type=str, required=True
    )
    parser.add_argument(
    ...
    convert_roberta_checkpoint_to_pytorch(
        args.roberta_checkpoint_path, args.checkpoint_name, args.pytorch_dump_folder_path, args.classification_head
    )
